...
Scarlet checks this repository's public latest-release endpoint at most once every 24 hours when automatic checks are enabled. It sends no account information, license key, presets, display settings, analytics, or telemetry. The app never downloads or executes an update itself; the update button opens the verified GitHub release page in your browser.
